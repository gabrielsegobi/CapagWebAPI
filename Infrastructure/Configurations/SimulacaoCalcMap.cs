...
namespace Infrastructure.Configurations
{
    public class SimulacaoCalcMap : IEntityTypeConfiguration<SimulacaoCalc>
    {
        public void Configure(EntityTypeBuilder<SimulacaoCalc> builder)
        {
            ...
            builder.Property(s => s.TipoSimulacao) .HasColumnName("tipo_simulacao").HasColumnType("ENUM('PREVIDE', 'OUTRO')").IsRequired();
            ...
            builder.HasMany(s => s.SimulacaoIntervalos)
            .WithOne(i => i.SimulacaoCalc)
            .HasForeignKey(i => i.IdSimulacaoCalc)
