...
{
    public class CreateCapagCalculadoraResultadoCommandValidator
        : AbstractValidator<CreateCapagCalculadoraResultadoCommand>
    {
        public CreateCapagCalculadoraResultadoCommandValidator()
        {
            RuleFor(x => x.Request)
                .NotNull()
