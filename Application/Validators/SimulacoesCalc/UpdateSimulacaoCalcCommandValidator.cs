...
{
    public class UpdateSimulacaoCalcCommandValidator : AbstractValidator<UpdateSimulacaoCalcCommand>
    {
        public UpdateSimulacaoCalcCommandValidator()
        {
            RuleFor(x => x.Id)
                .GreaterThan(0)
                .WithMessage("O ID da simulação deve ser maior que zero.");
