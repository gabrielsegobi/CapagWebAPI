...
namespace IntegrationTests.ValorCalcVariavelTests
{
    public class ValorCalcVariavelTest
    {
        ...
        //public async Task Handler_deve_ordenar_dados_corretamente(
        //    string sort,
        ...
        //    // Se não tem dados, não há o que ordenar
        //    if (data.Count <= 1)
        //        return;
        ...
        //    Action assertion = sort switch
        //    {
        //        "IdEmpresa" => () =>
        //            AssertOrder(data, x => x.IdEmpresa, orderByDescending),

        //        "IdTipoGrupo" => () =>
        //            AssertOrder(data, x => x.IdTipoGrupo, orderByDescending),

        //        "AnoBase" => () =>
        //            AssertOrder(data, x => x.AnoBase, orderByDescending),

        //        "Valor" => () =>
        //            AssertOrder(data, x => x.Valor, orderByDescending),

        //        _ => () =>
        //            AssertOrder(data, x => x.IdValorCalcVariavel, orderByDescending)
        //    };
        ...
        //private static void AssertOrder<T, TKey>(
        //    IEnumerable<T> data,
        //    Func<T, TKey> selector,
        //    bool desc)
        //    where TKey : IComparable  // <-- força ser comparável
        //{
        //    if (desc)
        //        data.Should().BeInDescendingOrder(x => (IComparable)selector(x));
        //    else
        //        data.Should().BeInAscendingOrder(x => (IComparable)selector(x));
        //}
